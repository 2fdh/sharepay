...
psql --username $1 -d sharepay2dfh_test -c "DROP INDEX activity_id_attendee_id_idx;"
...
psql --username $1 -d sharepay2dfh_test -c "DROP TABLE IF EXISTS expenses_attendees;"
psql --username $1 -d sharepay2dfh_test -c "DROP TABLE IF EXISTS attendees;"
psql --username $1 -d sharepay2dfh_test -c "DROP TABLE IF EXISTS activities;"

psql --host 127.0.0.1 --port 5432 --username $1 -d sharepay2dfh_test -f ./newdbexport.pgsql
